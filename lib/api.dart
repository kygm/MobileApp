...
class ClientsApi {
  ...
  Future<Transaction> createTransaction(String fname, String lname, String phoneNumber, String transactDate, String transactTime, String descript, var transactCost, var transactPrice) async{
    final response = await _dio.post('/addTransaction', data: {'fname' : fname, 'lname' : lname, 'transactDate': transactDate, 'descript' : descript, 'transactTime' : transactTime, 'transactCost' : transactCost, 'transactPrice' : transactPrice});
  }
